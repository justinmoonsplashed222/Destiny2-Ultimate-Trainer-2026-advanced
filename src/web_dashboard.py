...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-advanced.Dashboard")

class Dashboard:
    def __init__(self, trainer: GameTrainer, port=4205):
...
<html>
<head>
    <title>Destiny2-Ultimate-Trainer-2026-advanced Dashboard</title>
    <style>
        body { background: #1a1a2e; color: #b03a2e; font-family: sans-serif; }
...
<body>
    <h1>Destiny2-Ultimate-Trainer-2026-advanced</h1>
    <div id="features"></div>
    <script>
