...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-advanced.GameTrainer")
    ...
    def _update_discord(self):
        ...
        try:
            discordrpc.update_presence(state=", ".join(active) if active else "Idle",
                                       details="Destiny2-Ultimate-Trainer-2026-advanced", large_image="logo", large_text="v1.4.0")
        except:
            pass
